...
def plot(params):
  ...
  plt.plot(x, y_mean, label='average over 5 runs', color=color_code, linewidth=1.5)
  plt.fill_between(x_list[0], y_mean+y_std, y_mean-y_std, color=color_code, alpha=0.4)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--logdir', default='./experiments/oc', type=str, help='logdir to event file')
